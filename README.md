...
```
###################################################################################################################################
WAHDAN'S README BITCH
###################################################################################################################################

contributions:

1 - added support for guided attention in training and testing
2 - added support for koleo loss (used in Dinov2 "modified to account for multiple images of same person in a single batch") 



TODO:

1 - add support for more complex triplet loss (the one used in training llm embedding models ex:Qwen embedding , jina ,etc) (better usage of negative examples)


2 - add support for something like gram anchoring loss (used in Dinov3) to decorrelate the output patch tokens (make the correlation matrix match the corr matrix of a bigger smarter model)