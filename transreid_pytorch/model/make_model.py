...
class Backbone(nn.Module):
    ...
    def forward(self, x, label=None, mask=None, **kwargs):  # label is unused if self.cos_layer == 'no'
        x = self.base(x)
